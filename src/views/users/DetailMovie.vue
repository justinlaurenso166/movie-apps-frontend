        ...
        <div class="bg-white w-2/3 mt-10 m-auto shadow-lg rounded-lg p-10">
            <div class="border-b-2 border-gray-400 pb-4 flex justify-between">
                ...
                <div v-if="detail_movie.status !== 'coming_soon'">
                    ...
                    <img v-else :src="add_favorite.is_favorite ? `/assets/svg/Heart_fill.svg` : `/assets/svg/Heart.svg`" class="w-10 hover:cursor-pointer" @click="add_favorite.is_favorite = !add_favorite.is_favorite; addFavorite()">
                </div>
            </div>
